...
def main():
    ...
    balance = float(input("Enter the savings balance: "))
    ...
    savings_account = create_savings_account(balance, interest_rate, months)
    updated_balance, interest_earned = savings_account.calculate_interest(months)
